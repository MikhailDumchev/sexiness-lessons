    ...
    this.appendHandler = function() {
        ...
        for (var counter = 0; counter < buttons.length; counter++) {
            ...
            if (additoryVariable.nodeName === "FORM") {
                ...
                try {
                    spinnerObject = new Preloader();
                    spinnerObject.Container(document.body);
                } catch (error) {
    ...
    this.handleEvent = function(event) {
        ...
        XHR.onreadystatechange = function() {
            if (XHR.readyState === 4) {
                ...
                if (checkObject(spinnerObject)) spinnerObject.removePreloader();
            ...
            if (!document.body.hasAttribute(indicatorTitle)) {
                ...
                if (form.nodeName === "FORM") {
                    ...
                    if (permissionIndicator) {
                        ...
                        if (checkObject(spinnerObject)) spinnerObject.appendPreloader();
